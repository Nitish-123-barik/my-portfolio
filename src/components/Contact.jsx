...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "510b9732-33b1-4854-9f7e-28a48245b694");
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "nitishkumarbarik574@gmail.com",
      href: "mailto:nitishkumarbarik574@gmail.com"
    },
    {
      icon: <Phone className="w-6 h-6" />,
      label: "Phone",
      value: "+91 82607 22905",
      href: "tel:+918260722905"
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Nitish barik. Built with React and Tailwind CSS.
          </p>
        </div>
      </div>
    </section>
